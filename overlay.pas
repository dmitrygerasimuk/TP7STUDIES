...
var S:array[0..1001] of Drop;
	i,j: integer;
     ...
     BatScreen:ScrType;		{ is where i keep Batman}
	...
	begin
		...
		for i:=1 to 80 do Begin
			for j:=1 to 25 do begin
					...
					BackScreen[j,i].Attribute:=FrontScreen[j,i].Attribute+random(3);
